...
\noindent \underbar{\textbf{UC$<$2$>$ - Promjena lozinke}}
\begin{packed_item}
...
\noindent \underbar{\textbf{UC$<$4$>$ - Brisanje korisničkog računa}}
\begin{packed_item}
...
\noindent \underbar{\textbf{UC$<$5$>$ - Dodavanje administratora}}
\begin{packed_item}
...
\noindent \underbar{\textbf{UC$<$6$>$ - Brisanje administratora }}
\begin{packed_item}
...
\noindent \underbar{\textbf{UC$<$7$>$ - Pregledavanje i odabir jezika}}
\begin{packed_item}
...
\noindent \underbar{\textbf{UC$<$8$>$ - Pregledavanje i odabir rječnika}}
\begin{packed_item}
	...
	\item[] \begin{packed_enum}
		...
		\item[] \begin{packed_item}
			...
			\item učenika na zaslon za odabir načina učenja 
...
\noindent \underbar{\textbf{UC$<$9$>$ - Stvaranje rječnika}}
\begin{packed_item}
...
\noindent \underbar{\textbf{UC$<$10$>$ - Promjena sadržaja rječnika}}
\begin{packed_item}
...
\noindent \underbar{\textbf{UC$<$11$>$ - Promjena naziva rječnika}}
\begin{packed_item}
...
\noindent \underbar{\textbf{UC$<$12$>$ - Brisanje rječnika}}
\begin{packed_item}
...
\noindent \underbar{\textbf{UC$<$13$>$ - Prijevod strane riječi}}
\begin{packed_item}

	\item \textbf{Glavni sudionik: } Korisnik
	\item \textbf{Cilj: } Korisnik je naučio prijevod strane riječi ili izraza na hrvatski
	\item \textbf{Sudionici: } Baza podataka
	\item \textbf{Preduvjet: } Učenik je prijavljen, učenik je prethodno odabrao koji će jezik učiti, iz kojeg će rječnika učiti te je odabrao način učenja Prijevod strane riječi 
	\item  \textbf{Opis osnovnog tijeka:}
...
\noindent \underbar{\textbf{UC$<$14$>$ - Prijevod na strani jezik}}
\begin{packed_item}

	\item \textbf{Glavni sudionik: } Korisnik
	\item \textbf{Cilj: } Korisnik je naučio prijevod strane riječi ili izraza na hrvatski
	\item \textbf{Sudionici: } Baza podataka
	\item \textbf{Preduvjet: } Učenik je prijavljen, učenik je prethodno odabrao koji će jezik učiti, iz kojeg će rječnika učiti te je odabrao način učenja Prijevod na strani jezik 
	\item  \textbf{Opis osnovnog tijeka:} 
...
\noindent \underbar{\textbf{UC$<$15$>$ - Prijevod zvučnog zapisa}}
\begin{packed_item}

	\item \textbf{Glavni sudionik: } Korisnik
	\item \textbf{Cilj: } Korisnik slušajući razumije strani jezik
	\item \textbf{Sudionici: } Baza podataka
	\item \textbf{Preduvjet: } Učenik je prijavljen, učenik je prethodno odabrao koji će jezik učiti, iz kojeg će rječnika učiti te je odabrao način učenja Prijevod zvučnog zapisa 
	\item  \textbf{Opis osnovnog tijeka:} 
...
\noindent \underbar{\textbf{UC$<$16$>$ - Snimanje izgovora riječi}}
\begin{packed_item}
	...
	\item \textbf{Preduvjet: } Učenik je prijavljen, učenik je prethodno odabrao koji će jezik učiti, iz kojeg će rječnika učiti te je odabrao način učenja Snimanje izgovora 
	\item  \textbf{Opis osnovnog tijeka:} 
...
\noindent \underbar{\textbf{UC$<$17$>$ - Stvaranje riječi}}
\begin{packed_item}
...
\noindent \underbar{\textbf{UC$<$18$>$ - Pregledavanje riječi}}
\begin{packed_item}
...
\noindent \underbar{\textbf{UC$<$19$>$ - Brisanje riječi}}
\begin{packed_item}
...
\noindent \underbar{\textbf{UC$<$20$>$ - Uređivanje riječi}}
\begin{packed_item}
